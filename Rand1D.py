...
class SimpleRandomWalk1D:
    """Simple RandomWalk1D that mimics Gymnasium interface without full inheritance."""
    ...
    def __init__(self, size: int = 7):
        ...
        # Create spaces for compatibility
    ...
    def step(self, action: int):
        ...
        if action == 0:  # Left
            ...
            self.current_pos = min(self.size - 1, self.current_pos + 1)
        ...
        if self.current_pos == 0:
            reward = -1.0
            terminated = True
        elif self.current_pos == self.size - 1:
            reward = 1.0
            terminated = True
        else:
            reward = 0.0
        
        return self.current_pos, reward, terminated, False, {}
